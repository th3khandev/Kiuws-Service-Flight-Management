const flightDetailsSelectedComponent = {
  template: `
    <div class="row">
        ...
        <div class="row details-selected">
          ...
          <div class="col-9 col-sm-10 col-md-6 col-lg-6">
            <div class="deatil-selected-cities" v-if="originAirport && destinationAirport">
              ...
              - 
              <label>{{ destinationAirport.city }} <span>({{ destinationAirport.code }})</span>, {{ destinationAirport.name }}</label>
            </div>
            <div class="deatil-selected-date">
